export default {
  ...
  confirmed: (field, [confirmedField]) => `${field} e ${confirmedField} devem ser iguais.`,
  ...
  max: (field, [length]) => `${field} não deve ter mais que ${length} caracteres.`,
  ...
  min: (field, [length]) => `${field} deve conter pelo menos ${length} caracteres.`,
